...
public class FieldOfView : MonoBehaviour {
    ...
    void DrawFieldofView()
    {
        ...
        for (int i=0; i <= stepCount; i++)
        {
            ...
            if (i > 0)
            {
                bool edgeDstTresholdExceeded = Mathf.Abs(oldViewCast.dst - newViewCast.dst) > edgeDistanceTreshold;
    ...
    EdgeInfo FindEdge(ViewCastInfo minViewCast, ViewCastInfo maxViewCast)
    {
        ...
        for (int i = 0; i < edgeResolveIterations; i++)
        {
            ...
            bool edgeDstTresholdExceeded = Mathf.Abs(minViewCast.dst - newViewCast.dst) > edgeDistanceTreshold;
